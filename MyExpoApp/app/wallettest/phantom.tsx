...
const onConnectRedirectLink = Linking.createURL("phantom?event=onConnect");
const onDisconnectRedirectLink = Linking.createURL("phantom?event=onDisconnect");
const onSignAndSendTransactionRedirectLink = Linking.createURL("phantom?event=onSignAndSendTransaction");
const onSignAllTransactionsRedirectLink = Linking.createURL("phantom?event=onSignAllTransactions");
const onSignTransactionRedirectLink = Linking.createURL("phantom?event=onSignTransaction");
const onSignMessageRedirectLink = Linking.createURL("phantom?event=onSignMessage");
...
export default function PhantomScreen() {
  ...
  useEffect(() => {
    ...
    console.log("handleDeepLink", { url, params, event });
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff", marginTop: 105, marginBottom: 200}}>
      ...
      <View style={{ flex: 0, paddingTop: 20, paddingBottom: 40, backgroundColor: "red" }}>
